...
class AnalizadorLexico(TipoCadena):
    ...
    def tipoCadena(self, tipo):
        ...
        switch = {
            ...
            self.CHAR: self.m_CHAR,
            self.PESO: self.m_PESO,
            self.TIPODATO: self.m_TIPODATO
        }
    ...
    def esSaltoLinea(self, caracter):
        return caracter == "\n"
    ...
    def estado01(self):
        if self.esPeso(self.caracter):
            ...
            self.estado = 1
        elif self.esSaltoLinea(self.caracter):
            self.estado = 1
        else:
            self.simbolo += self.caracter
            self.continua = False
    ...
    def m_CHAR(self):
        self.tipoCadenaMensaje = "char"

    def m_TIPODATO(self):
        self.tipoCadenaMensaje = "Tipo dato"